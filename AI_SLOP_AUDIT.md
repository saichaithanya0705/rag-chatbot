...
- Added a dedicated readiness endpoint for Render and changed the frontend bootstrap flow to wait for backend readiness instead of treating transient cold-start `503`s as a permanent failure.
